...
<form name="form1" id="form1">
 <div class="row" style="max-width:100%">
     <div class="col-md-12">
        ...
        <div class="col-md-4"> 
        <strong>Nueva Descripción Tipo:</strong> <input name="nuevoTipo+" type="text" id="nuevoTipo+" value="" size="13">
            <p style="background:#FFFFCC;margin-bottom:13px">Si és una nueva descripción tipo</p> 
        </div>
        ...
        <div class="col-md-2"> 
         ...
         <div class="col-md-2">
          <strong>Otra Zona:</strong>
            ...
            <p style="background:#FFFFCC;margin-bottom:13px">Sant Cugat 1 si no 0 </p> 
        </div>     
    ...
    <div class="col-md-12" style="margin-top:21px">
     ...
     <div class="col-md-12" style="margin-top:21px">
        <div class="col-md-8">
        	<strong style="background:#ddd; padding:8px">Descripción Corta: </strong> &nbsp; 
            <input style="max-width:100%" name="descc" type="text" id="descc" value="<?=$vivienda->DescCorta?>" size="65" maxlength="80">
        </div>  
        <div class="col-md-4">
        	&nbsp;
        </div>  
    ...
    <div class="col-md-12" style="margin-top:21px">
          ...
          <div class="col-md-8" name="descllarga" id="descllarga" style="border-color:#999999; border-style:solid; border-width:thin;  font-family:Arial, Helvetica, sans-serif; font-size:15px; min-height:144px" contenteditable="true">
          		<?=$vivienda->DescLarga?>
          </div>
  ...
  <div class="col-md-12" style="margin:21px 0 34px 0; text-align:center">
        ...
        <div class="col-md-2">
            <a style="color:inherit" href="<?=base_url('detalle/').$vivienda->Tipus.'/'.$vivienda->Zona.'/',$vivienda->Ref?>" target="_blank">
                <input name="buttonsv" id="buttonsv" type="button" class="botones"  value="Ver Resultado" style="width:144px"> 
           </a>
       </div>
        <div class="col-md-2">
...
<script language="JavaScript">
     document.getElementById("mantcontainer").style.width="93%"; 
	...
	document.getElementById("buttonsv").style.display="none";
	}
